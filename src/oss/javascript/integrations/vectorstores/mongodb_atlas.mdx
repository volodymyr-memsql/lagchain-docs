...
In **manual embedding mode**, you provide an embeddings model and embed documents client-side. This guide uses [OpenAI embeddings](/oss/integrations/embeddings/openai) as an example. You can also use [other supported embeddings models](/oss/integrations/embeddings).
