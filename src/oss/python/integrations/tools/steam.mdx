...
To use this toolkit, please have your OpenAI API Key, Steam API key (from the [Steam developer API key page](https://steamcommunity.com/dev/apikey)) and keep your own SteamID handy. Once you have received a Steam API Key, you can input it as an environmental variable below.
