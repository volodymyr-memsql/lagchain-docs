...
See a variety of [Perplexity usage examples](/oss/integrations/chat/perplexity).
...
You can use the [`PerplexitySearchRetriever`](/oss/integrations/retrievers/perplexity_search) to fetch web search results from the [Perplexity Search API](https://docs.perplexity.ai/docs/search/quickstart) as @[`Document`] objects in a standard retrieval pipeline.

See a [usage example](/oss/integrations/retrievers/perplexity_search).
...
See a [usage example](/oss/integrations/tools/perplexity_search).
