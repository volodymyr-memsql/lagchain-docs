...
See the [usage example](/oss/integrations/chat/databricks) for more guidance on how to use it within your LangChain application.
...
See the [usage example](/oss/integrations/llms/databricks) for more guidance on how to use it within your LangChain application.
...
See the [usage example](/oss/integrations/embeddings/databricks) for more guidance on how to use it within your LangChain application.
...
See the [usage example](/oss/integrations/vectorstores/databricks_vector_search) for how to set up vector indices and integrate them with LangChain.
...
See [MLflow LangChain Integration](/oss/integrations/providers/mlflow_tracking) to learn about the full capabilities of using MLflow with LangChain through extensive code examples and guides.
...
To directly integrate Databricks's open models hosted on HuggingFace, you can use the [HuggingFace Integration](/oss/integrations/providers/huggingface) of LangChain.
