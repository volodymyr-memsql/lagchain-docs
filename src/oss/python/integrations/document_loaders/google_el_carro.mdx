...
[save, load and delete langchain documents](/oss/integrations/document_loaders)
...
section [Load documents with customized document page content & metadata](#load-documents-with-customized-document-page-content-and-metadata).
