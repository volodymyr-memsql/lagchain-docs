...
1. Click the **Submit** button. This will add a [run](/langsmith/runs) to the existing selected [thread](/oss/langgraph/persistence#threads). If no thread is currently selected, a new one will be created.
