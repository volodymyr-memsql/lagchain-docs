...
Check your URL - any organizations on [https://eu.smith.langchain.com](https://eu.smith.langchain.com) are in the EU on GCP. Organizations on [https://smith.langchain.com](https://smith.langchain.com) are in the US on GCP, and organizations on [https://aws.smith.langchain.com](https://aws.smith.langchain.com) are in the US on AWS.
