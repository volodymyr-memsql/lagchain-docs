...
<Steps>
  ...
  <Step title="(Optional) Configure for Istio Gateway">
    If you are using an Istio Gateway, you must use LangSmith version 0.13.38 or later. Add the following to your [`langsmith_config.yaml`](/langsmith/kubernetes#configure-your-helm-charts) before upgrading:
