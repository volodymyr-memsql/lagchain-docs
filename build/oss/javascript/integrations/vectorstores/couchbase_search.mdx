...
You can find the different search/query possibilities for the `searchOptions` in the [Couchbase search request parameters documentation](https://docs.couchbase.com/server/current/search/search-request-params.html#query-object).
