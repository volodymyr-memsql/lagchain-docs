...
[GoogleCloudStorageDocstore](https://reference.langchain.com/javascript/langchain-community/stores/doc/gcs/GoogleCloudStorageDocstore) to store it more permanently.
...
set for the document. If we just wanted to limit the results to those
