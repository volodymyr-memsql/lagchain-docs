...
This will help you getting started with `TavilySearchAPIRetriever` [retrieval](/oss/javascript/langchain/retrieval). For detailed documentation of all `TavilySearchAPIRetriever` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever).

### Integration details

| Retriever | Source | Package |
| :--- | :--- | :---: |
[`TavilySearchAPIRetriever`](https://reference.langchain.com/javascript/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever) | Information on the web. | [`@langchain/community`](https://npmjs.com/@langchain/community/) |
...
For detailed documentation of all `TavilySearchAPIRetriever` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever).
