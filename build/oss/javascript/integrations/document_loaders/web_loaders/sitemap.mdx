...
This notebook goes over how to use the [`SitemapLoader`](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/sitemap/SitemapLoader) class to load sitemaps into `Document`s.
