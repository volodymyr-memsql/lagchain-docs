...
This notebook provides a quick overview for getting started with `CheerioWebBaseLoader` [document loaders](/oss/javascript/integrations/document_loaders/). For detailed documentation of all `CheerioWebBaseLoader` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/cheerio/CheerioWebBaseLoader).
...
For detailed documentation of all `CheerioWebBaseLoader` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/cheerio/CheerioWebBaseLoader).
