...
Infobip provides many services, but this notebook will focus on SMS and Email services. For more information, see [API and other channels](https://www.infobip.com/docs/api).
