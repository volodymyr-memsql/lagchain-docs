...
You are given a 1 hour free of serverless GPU compute to test different models. (see the [deepctl documentation](https://github.com/deepinfra/deepctl#deepctl))
