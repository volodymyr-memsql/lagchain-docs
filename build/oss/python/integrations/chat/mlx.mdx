...
Here we'll test out `gemma-2b-it` as a zero-shot `ReAct` Agent. The example below is based on the [LangChain ReAct agent documentation](https://python.langchain.com/docs/modules/agents/agent_types/react#using-chat-models).
