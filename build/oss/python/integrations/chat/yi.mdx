...
This will help you get started with Yi [chat models](/oss/python/langchain/models).
...
The LangChain ChatYi integration lives in the `langchain_community` package:
