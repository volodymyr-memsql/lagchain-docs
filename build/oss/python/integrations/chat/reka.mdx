...
This guide provides a quick overview for getting started with `ChatReka` [chat models](/oss/python/langchain/models).
...
The LangChain ChatReka integration lives in the `langchain_community` package:
