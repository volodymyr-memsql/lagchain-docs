...
This will help you get started with OCIModelDeployment [chat models](/oss/python/langchain/models). For detailed documentation of all `ChatOCIModelDeployment` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/chat-models).
