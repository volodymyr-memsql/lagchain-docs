...
To download your own messenger data, follow the [instructions for downloading Facebook Messenger chat history](https://www.zapptales.com/en/download-facebook-messenger-chat-history-how-to/). IMPORTANT - make sure to download them in JSON format (not HTML).
