...
1. Dashboards with advanced filtering options
...
You can use the open-source evaluation service to evaluate your model. UpTrain uses the GPT models to evaluate the responses generated by the LLM. You must provide an [OpenAI API key](https://platform.openai.com/account/api-keys).
...
Alternatively, you can use UpTrain's managed service to evaluate your model. You can [create a free UpTrain account](https://uptrain.ai/) and get free trial credits. If you want more trial credits, [book a call with the maintainers of UpTrain](https://calendly.com/uptrain-sourabh/30min).
