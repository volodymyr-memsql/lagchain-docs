...
Notice that the board "name" is also called "title" in official documentation:
...
By default all card fields are included for the full text page_content and metadata accordingly.
