---
title: "HuggingFace dataset integration"
description: "Integrate with the HuggingFace dataset document loader using LangChain Python."
---
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/hugging_face_dataset.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
