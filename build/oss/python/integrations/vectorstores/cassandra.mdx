...
For more, check out the [complete RAG template using Astra DB through CQL](https://github.com/langchain-ai/langchain/tree/master/templates/cassandra-entomology-rag).
