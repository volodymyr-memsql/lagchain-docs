...
For detailed documentation of all `ElasticSearchStore` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-elasticsearch/vectorstores/ElasticsearchStore)
