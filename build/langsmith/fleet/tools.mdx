...
<Tabs>
  ...
  <Tab title="From the agent editor">
    ...
    1. In [Fleet](https://smith.langchain.com), select the agent to which you want to add the tool.
    1. In the graph view, navigate to the **Toolbox** section and click **+ Add**.
...
<Steps>
  <Step title="Select the agent">
    In [Fleet](https://smith.langchain.com), select the agent from which you want to remove the tool.
  </Step>
