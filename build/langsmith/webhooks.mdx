...
We will do that by [creating a Modal secret](https://modal.com/docs/guide/secrets).
...
We can now deploy this easily with `modal deploy ...` (see [managing Modal deployments](https://modal.com/docs/guide/managing-deployments)).
