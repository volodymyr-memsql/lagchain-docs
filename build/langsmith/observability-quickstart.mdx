...
You can also use the `traceable` decorator for [Python](https://docs.smith.langchain.com/reference/python/run_helpers/langsmith.run_helpers.traceable) or [TypeScript](https://reference.langchain.com/javascript/langsmith/traceable/traceable) to trace your entire application instead of just the LLM calls.
